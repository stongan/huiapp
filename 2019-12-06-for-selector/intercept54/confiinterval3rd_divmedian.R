...
write.csv(G1ratioG2med, file=paste0(scriptpath,"/estimateG1/g1ratiodivmedian.csv"))
G1ratioG2 <- G1ratioG2med
...
getG12HLinterval <- function(){
  ...
  write.csv(compareretratio, file=paste0(scriptpath,"/estimateG1/compareretratiodivmedian.csv"))
}
